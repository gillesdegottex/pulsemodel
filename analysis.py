...
def analysisf(fwav,
    ...
    if f0_file:
        ...
        if not os.path.isdir(os.path.dirname(f0_file)): os.mkdir(os.path.dirname(f0_file))
    ...
    if spec_file:
        ...
        if not os.path.isdir(os.path.dirname(spec_file)): os.mkdir(os.path.dirname(spec_file))
    ...
    if pdd_file:
        ...
        if not os.path.isdir(os.path.dirname(pdd_file)): os.mkdir(os.path.dirname(pdd_file))
    ...
    if nm_file:
        ...
        if not os.path.isdir(os.path.dirname(nm_file)): os.mkdir(os.path.dirname(nm_file))
